...
def run_minecart_mission():
    ...
    bot.drive_straight(speed=250, distance=415, acceleration=100)
    bot.turn(speed=100, degrees=-90)
    bot.drive_straight(speed=250, distance=-124, acceleration=100)
    bot.right_attachment_motor.run_angle(speed=600, rotation_angle=-440)
    bot.drive_straight(speed=250, distance=72, acceleration=100)
    bot.right_attachment_motor.run_angle(600, 210)
    bot.drive_straight(speed=250,distance=155, acceleration=100)
    bot.left_attachment_motor.run_angle(620, 950)
    bot.left_attachment_motor.run_angle(420, -950)
